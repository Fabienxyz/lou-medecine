...
> **Cadre normatif.** L'architecture d'acquisition est gelée (ADR-004). Ce plan couvre l'**industrialisation des artefacts métier aval** — Phase 1 de [`MASTER_ROADMAP.md`](../MASTER_ROADMAP.md).
...
| **lou-build** | courant | validate / build / traceability | 96 tests, 234+330 PASS |
