...
**Dernière mise à jour :** 2026-08-01 (D7 publié — préférences d'affichage ; chantier actif : Amorçage + acceptation Reader)
...
| **Blocage structurant** | Critères d'**acceptation** Reader V1 non prononcés — Amorçage (1 vue `planned`) ouvert ; implémentation D7 **publiée** |
| **Dernier jalon produit** | **D7 publié** — préférences d'affichage Reader ([`DISPLAY-PREFERENCES-COMPONENT-CONTRACT.md`](contracts/components/DISPLAY-PREFERENCES-COMPONENT-CONTRACT.md) en vigueur ; lots D7-A…G ; tag `display-preferences-v1` ; validation D7-F **589 unit + 18 smoke DP-F PASS** |
...
|---|---|---|
| **Reader Acceptance V1** | Acceptation Reader V1 | Phase **active** — critères PDR-B1/B5/D/E sur package 234 complet ; PDR-D1, PDR-D2, **PDR-D4**, **PDR-D6**, **PDR-D7** **publiés** ; **Amorçage** ouvert |
...
| **Reader Composition V1** | **Publiée** — tag `reader-composition-v1` ; Spec, Engine, ViewModel en production ; **589 unit PASS** (dont D7-C/D/D/E/F) | Audit indépendant ✅ Conforme |
...
| **PDR-D6 — Recherche locale** | **Publié** — tag `local-search-v1` ; contrat [`LOCAL-SEARCH-COMPONENT-CONTRACT.md`](contracts/components/LOCAL-SEARCH-COMPONENT-CONTRACT.md) en vigueur ; lots D6-A…G ; **589 unit + 19 smoke LS-F PASS** (D6-F) | Implémentation Reader validée localement |
| **PDR-D7 — Préférences d'affichage** | **Publié** — tag `display-preferences-v1` ; contrat [`DISPLAY-PREFERENCES-COMPONENT-CONTRACT.md`](contracts/components/DISPLAY-PREFERENCES-COMPONENT-CONTRACT.md) en vigueur ; lots D7-A…G ; **589 unit + 18 smoke DP-F PASS** (D7-F) |
| **Reader V1 — critères d'acceptation** | **Non prononcés** — phase Reader Acceptance V1 active | 1 vue `planned` (Amorçage) ; Collège officiel alimenté ; **PDR-D1 clôturé** ; **PDR-D2 clôturé** ; **PDR-D4 clôturé** ; **PDR-D6 clôturé** ; **PDR-D7 clôturé** ; patrimoine E-A…E-D clôturé ; fixture CI branchée |
...
| Date | Événement |
|---|---|
| 2026-08-01 | **Publication D7** — clôture documentaire D7-G ; [`DISPLAY-PREFERENCES-COMPONENT-CONTRACT.md`](contracts/components/DISPLAY-PREFERENCES-COMPONENT-CONTRACT.md) en vigueur ; lots D7-A…G ; **589 unit + 18 smoke DP-F PASS** ; chantier actif → Amorçage + acceptation Reader |
...
*Révision 2026-08-01 — D7 publié (préférences d'affichage / PDR-D7) ; contrat Display Preferences en vigueur ; 589 unit + 18 smoke DP-F PASS ; chantier actif : Amorçage + acceptation Reader — non prononcée.*
