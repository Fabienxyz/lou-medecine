...
|---|---|---|
| **Reader Acceptance V1** | Acceptation Reader V1 | Phase **active** — critères PDR-B1/B5/D/E sur package 234 complet ; **D1-A** contrat Library Catalog en vigueur ; suite D1-B… ; infra offline minimale ; **PDR-D2 complet ouvert** ; Amorçage, patrimoine, reprise, recherche ouverts |
